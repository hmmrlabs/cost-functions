...
\midrule
temporal            & 1.077 & 1.022 & 1.182 & 1.662 & 1.236 \\
company             & 1.028 & 0.994 & 1.171 & 1.619 & 1.203 \\
paired difference   & $+0.049$ & $+0.028$ & $+0.010$ & $+0.043$ & $+0.033$ \\
\bottomrule
\end{tabular}
\end{center}

The in-sample penalty is larger under the temporal split in 66 of 120 paired cells, which is a
coin flip, and dropping any single origin moves the difference between $+0.004$ and $+0.071$ on a
...
\midrule
S0 in-sample         & 0.315 & 0.230 & 1.37 \\
S1 out-of-fold       & 0.101 & 0.045 & 2.25 \\
S4 validation        & 0.068 & 0.032 & 2.12 \\
\midrule
oracle, absolute cost & 0.900 & 0.890 & 1.01 \\
\bottomrule
\end{tabular}
\end{center}
